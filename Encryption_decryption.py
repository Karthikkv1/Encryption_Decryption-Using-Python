# we need to install "pip install pybase64"
...
def main_screen():
    ...
    code=StringVar()
    Entry(textvariable=code,width=19,bd=0,font=("arial",25),show="*").place(x=10,y=200) #This line is for showing * ,instead of typed values
